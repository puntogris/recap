package com.puntogris.recap.feature_profile.presentation.profile.profile_recaps
...
@AndroidEntryPoint
class UserRecapsFragment :
    BasePagerTabFragment<FragmentUserRecapsBinding>(R.layout.fragment_user_recaps) {
