package com.puntogris.recap.core.presentation.widget
...
import com.puntogris.recap.databinding.ExpandableCardViewBinding
...
class ExpandableCardView @JvmOverloads constructor(
    ...
    fun setOnExpandChangeListener(expandChangeUnit: (Boolean) -> Unit) {
        listener = object : OnExpandChangeListener {
            override fun onExpandChanged(isExpanded: Boolean) {
                println(isExpanded)
                expandChangeUnit.invoke(isExpanded)
            }
        }
    }
    ...
    private fun initClickListeners() {
        val views = getViewsByTag(binding.root as ViewGroup, "expand_or_collapse")
        views.forEach {
